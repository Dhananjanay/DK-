...
public class ExtentReportGenerator extends BaseClass {
    ...
    private static String reportFileName = "ExtentReports-Version3-Test-Automaton-Report"+formatter.format(time)+".html";
    ...
    public static ExtentReports createInstance(){
       ...
       /* File file = new File(fileName);
        ...
        extent.setSystemInfo("Testing Application URL",Config.getProperty("Testing_URL"));
        extent.setSystemInfo("Browser Name",Config.getProperty("BrowserName"));
